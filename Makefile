...
validate:
	...
	$(PYTHON) -c "from marketlab.h003_content import load_and_validate_content_rule; d=load_and_validate_content_rule('registry/h003_content_rule.yaml'); print(f\"H003 content rule valid: {d['id']} sha256={d['sha256']}\")"
