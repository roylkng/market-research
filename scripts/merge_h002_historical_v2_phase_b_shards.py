...
from marketlab.h002_historical_v2_outcomes import phase_b_manifest_v2
    ...
    for path in files:
        ...
        for record in records:
            ...
            if key in seen_records:
                raise ValueError(f"duplicate HR002 Phase-B record across shards: {key}")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Merge H002-HR002 Phase-B outcome shards")
