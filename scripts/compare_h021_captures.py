...
def main() -> None:
    ...
    output = {
        ...
        "primary_signal": "30-day consensus EPS revision when both captures expose same-period EPS",
        "primary_signal_available_count": sum(int(row["primary_signal_available"]) for row in revisions),
    ...
    print(
        f"compared={len(revisions)} primary_available={output['primary_signal_available_count']} "
