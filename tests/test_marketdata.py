...
def test_index_snapshot_parser_uses_exact_open_and_close():
    raw = (
        ...
        b"Nifty 500,04-09-2026,22000,22100,21900,22050,1,.1,1,2,3,4,5\n"
    ...
    nifty500 = parse_index_snapshot(
        raw, benchmark_id="nifty_500", session_date=date(2026, 9, 4)
    )
    ...
    assert nifty500.close_price == 22050.0
